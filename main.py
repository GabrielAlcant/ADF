...
class DFA:
    def __init__(self, alphabet: set, states: set, transictions: dict, initialState: str, finalState: str):
        self.alphabet = alphabet
        self.states = states
        self.transitions = transictions
        self.initialState = initialState
        self.finalState = finalState

    @staticmethod
    def separatetype(string: str):
    ...
    def run(self, string: str):
        ...
        entryData = self.separatetype(string)
...
dfa = DFA(
    alphabet=IUM,
    states={"q0", "q1", "qf"},
    transictions=transitions,
    initialState="q0",
    finalState="qf"
)

declaration = input("Declare uma variavel em C++ :\n")
dfa.run(declaration)